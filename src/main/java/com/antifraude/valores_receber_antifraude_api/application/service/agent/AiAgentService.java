...
import com.antifraude.valores_receber_antifraude_api.application.service.threat.ThreatIntelResult;
import com.antifraude.valores_receber_antifraude_api.application.service.threat.ThreatIntelService;
import com.antifraude.valores_receber_antifraude_api.application.service.threat.ThreatReputation;
...
public class AiAgentService {
    ...
    public Result classify(String normalizedUrl, String domain, int rulesScoreBase) {
        ...
        ThreatIntelResult ti = threatIntelService.check(normalizedUrl, domain);
    ...
    private Result decideByThreatIntel(
        ...
        evidence.add("Threat Intel reputação: " + ti.getReputation().name());

        // Malicioso com base em Threat Intel
        if (ti.getReputation() == ThreatReputation.MALICIOUS) {
        ...
        if (ti.getReputation() == ThreatReputation.CLEAN && rulesScoreBase < CLEAN_MAX_RULES_SCORE) {
        ...
        if (ti.getReputation() == ThreatReputation.UNKNOWN) {
